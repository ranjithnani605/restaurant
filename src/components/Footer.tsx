...
import { MapPin, Phone, Clock, Mail, Facebook, Instagram, Twitter, Link } from 'lucide-react';
import logo from '../../public/Full-Logo-1.jpg';

const Footer = () => {
  return (
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        {/* Grid layout: 1 col on mobile, 2 on tablets, 4 on desktop */}
          ...
          <div>
            <div className="flex items-center">
              ...
              <img 
                ...
                className="h-10 w-30 pb-2" // adjust size as needed
              />
          ...
          <div>
            ...
            <div className="space-y-2">
              <div className="flex items-center">
                ...
                <span className="text-gray-300 text-sm"> 62 Brudenell Rd, Leeds LS6 1EG, <br/>United Kingdom</span>
              </div>
              <div className="flex items-center">
                <Phone className="h-4 w-4 text-green-400 mr-2" />
                <span className="text-gray-300 text-sm">++44 7775604501</span>
              </div>
              <div className="flex items-center">
